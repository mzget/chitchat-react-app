    ...
    <MuiThemeProvider>
          <Row style={{height: "100vh"}}>
            <Col md={6} mdOffset={3}>
               ...
               <Row>
                    <Col md={12}>
                        <div style={Object.assign(PageBox, {backgroundColor: "white", height: "100%"}, Styles.generalStyles.marginTop1Percent)}>
                            <Row>
                            ...
                            <Row>
                                <Col md={10} mdOffset={1}>
                                    <Panel style={Object.assign(Styles.generalStyles.gridCenter, Styles.generalStyles.margin2Percent)}>
                                        <Col md={12} >
