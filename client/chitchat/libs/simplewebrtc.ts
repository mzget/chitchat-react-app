...
class SimpleWebRTC extends WildEmitter {
    ...
    handlePeerStreamAdded = function (peer) {
        var self = this;
    ...
    handlePeerStreamRemoved = function (peer) {
        var container = this.getRemoteVideoContainer();
    ...
    setVolumeForAll = function (volume) {
    ...
    getLocalVideoContainer = function () {
    ...
    getRemoteVideoContainer = function () {
