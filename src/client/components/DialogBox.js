...
const actions = (props) => [
    React.createElement(FlatButton, { label: "Cancel", primary: true, onTouchTap: props.handleClose }),
    React.createElement(FlatButton, { label: "Submit", primary: true, keyboardFocused: true, onTouchTap: props.handleClose }),
];
