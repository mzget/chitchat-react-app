...
const renderList = (props) => props.value.map((item, i) => React.createElement("div", { key: i },
    React.createElement(List_1.ListItem, { onClick: (!!props.onSelected) ? () => props.onSelected(item) : () => { }, leftAvatar: (!!item.avatar) ?
            React.createElement(Avatar_1.default, { src: item.avatar }) : React.createElement(Avatar_1.default, null, item.username.charAt(0)), rightIcon: (props.rightIcon) ? props.rightIcon : null, primaryText: item.username, secondaryText: React.createElement("p", null,
