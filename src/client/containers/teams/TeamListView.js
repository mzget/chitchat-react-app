...
const getItem = (props) => {
    return props.items.map((item, i, arr) => React.createElement(List_1.ListItem, { key: i, primaryText: item.name, leftIcon: React.createElement(grade_1.default, null), rightIcon: React.createElement(info_1.default, null), onClick: () => props.onSelectItem(item._id) }));
};
