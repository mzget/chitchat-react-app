...
class ChatRoom extends React.Component {
    ...
    renderCustomActions(props) {
        if (Platform.OS === 'ios') {
            return (React.createElement(CustomActions, __assign({}, props)));
        }
        const options = {
            'Action 1': (props) => {
                alert('option 1');
        ...
        return (React.createElement(Actions, __assign({}, props, { options: options })));
    }
    renderBubble(props) {
        return (React.createElement(Bubble, __assign({}, props, { wrapperStyle: {
                left: {
    ...
    renderCustomView(props) {
        return (React.createElement(CustomView, __assign({}, props)));
    }
    renderFooter(props) {
        if (this.state.typingText) {
            return (React.createElement(View, { style: styles.footerContainer },
                React.createElement(Text, { style: styles.footerText }, this.state.typingText)));
        }
        return null;
    }
    renderMessageImage(props) {
        return React.createElement(MessageImage, __assign({}, props));
    }
    render() {
        return (React.createElement(GiftedChat, { messages: this.state.messages, onSend: this.handleSend, loadEarlier: this.state.earlyMessageReady, isLoadingEarlier: this.state.isLoadingEarlierMessages, isLoadingEarlierMessages: this.state.isLoadingEarlierMessages, onLoadEarlier: this.onLoadEarlierMessages, onErrorButtonPress: this.onErrorButtonPress.bind(this), user: {
                _id: this.props.profileReducer.form.profile._id,
            }, renderMessageImage: this.renderMessageImage, renderActions: this.renderCustomActions, renderBubble: this.renderBubble, renderCustomView: this.renderCustomView, renderFooter: this.renderFooter }));
    }
}
/**
 * ## Redux boilerplate
