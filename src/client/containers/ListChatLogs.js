...
const renderList = (props) => (props.value.map((log, i) => {
    return (React.createElement("div", { key: i },
        React.createElement(List_1.ListItem, { onTouchEnd: () => props.onSelected(log), onMouseUp: () => props.onSelected(log), leftAvatar: (!!log.room.image) ?
                React.createElement(Avatar_1.default, { src: log.room.image }) : React.createElement(Avatar_1.default, null, log.roomName.charAt(0)), primaryText: log.roomName, secondaryText: React.createElement("p", null,
