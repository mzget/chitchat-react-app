...
var SigninBox = (function (_super) {
    ...
    SigninBox.prototype.render = function () {
        return (<div>
                <SigninForm_1.SigninForm username={this.state.username} onUsername={this.onUsername} password={this.state.password} onPassword={this.onPassword} onSubmit={this.onSubmitForm}/>
            </div>);
    };
    return SigninBox;
}(React.Component));
