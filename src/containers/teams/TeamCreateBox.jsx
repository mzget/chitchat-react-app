...
var TeamCreateBox = (function (_super) {
    ...
    TeamCreateBox.prototype.render = function () {
        return (<div>
            ...
            <TeamCreateView_1.TeamCreateView team_name={this.state.team_name} onNameChange={this.onNameChange} onCreateTeam={this.onSubmitTeam} onFindTeam={this.onToggleView}/>
            :
                <FindTeamView_1.FindTeamView onSubmit={this.onFindTeamPress} onNameChange={this.onNameChange} onCreateNewPress={this.onToggleView} team_name={this.state.team_name}/>}
                <FindTeamListBox_1.FindTeamListBox findingTeams={this.props.teamReducer.findingTeams} onSelectTeam={this.onSelectTeam}/>
            </div>);
    };
