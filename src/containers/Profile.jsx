    ...
    Profile.prototype.render = function () {
        return (<div>
                <div id={"toolbar"} style={{ height: this.headerHeight, overflowY: "hidden" }}>
                    <SimpleToolbar_1.SimpleToolbar title={"Profile"} onBackPressed={this.onBackPressed}/>
                </div>
                <div id={"app_body"} style={{ backgroundColor: Colors.indigo50, overflowX: "hidden", margin: 0, padding: 0, height: this.bodyHeight }}>
                    <ProfileDetailEnhancer_1.ProfileDetailEnhanced user={this.props.userReducer.user} teamProfile={this.props.userReducer.teamProfile} alert={this.props.onError}/>
                </div>
            </div>);
    };
    return Profile;
