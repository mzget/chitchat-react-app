...
var UploadingDialog = (function (_super) {
    ...
    UploadingDialog.prototype.render = function () {
        ...
        var actions = [
            <FlatButton_1.default label={this.state.closeLabel} primary={true} onClick={this.cancelFileUpload}/>
        ];
        var getMediaCard = function () {
            if (chatroomReducer.fileInfo.type.match(FileType.imageType)) {
                return (<SimpleCardImage_1.default src={chatroomReducer.uploadingFile}/>);
            }
                ...
                return (<SimpleCardVideo_1.default src={chatroomReducer.uploadingFile}/>);
            }
        };
        return (<MuiThemeProvider_1.default>
                <Dialog_1.default title={this.state.dialogTitle} actions={actions} modal={true} open={this.state.openState}>
