...
export let ProfileEnhanced = ProfileListViewEnhancer(({ userReducer, onClickMyProfile }) => (React.createElement(ProfileListView, { item: userReducer.user, onSelected: onClickMyProfile })));
