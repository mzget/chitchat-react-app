...
var Team = (function (_super) {
    ...
    Team.prototype.render = function () {
        return (<MuiThemeProvider_1.default>
                <div>
                    <SimpleToolbar_1.SimpleToolbar title={this.toolbar} menus={["logout"]} onSelectedMenuItem={this.onToolbarMenuItem}/>
                    <TeamListBox_1.TeamListBox teams={this.props.teamReducer.teams} onSelectTeam={this.onSelectTeam}/>
                    <TeamCreateBox_1.TeamCreateBox {...this.props}/>
                </div>
