...
var ToolbarEnhanced = ToolbarEnhancer_1.ToolbarEnhancer(function (_a) {
    ...
    return (<SimpleToolbar_1.SimpleToolbar title={(chatroomReducer.room && chatroomReducer.room.name) ? chatroomReducer.room.name : "Empty"} menus={toolbarMenus} onSelectedMenuItem={onMenuSelect} onBackPressed={onBackPressed}/>);
});
exports.ChatPageEnhanced = DialogBoxEnhancer_1.DialogBoxEnhancer(function (_a) {
    ...
    return (<div>
        ...
        <Chat_1.ChatPage onError={onError} history={history} match={match}/>
