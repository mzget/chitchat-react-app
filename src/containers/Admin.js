...
class Admin extends React.Component {
    constructor() {
        ...
        this.menus = [this.manageOrgChart, createOrgGroup, createPjbGroup, createPvGroup, this.teamMember];
    }
    componentWillMount() {
        this.state = {
    ...
    getAdminPanel() {
        switch (this.state.boxState) {
            case BoxState.isManageTeam:
                return React.createElement(ManageOrgChartBox, __assign({}, this.props, { onError: this.props.onError }));
            case BoxState.isCreateGroup:
                return React.createElement(CreateGroupBox, __assign({}, this.props, { groupType: this.state.menuSelected, onError: this.props.onError }));
            case BoxState.isManageMember:
                return React.createElement(TeamMemberBox, __assign({}, this.props, { onError: this.props.onError }));
            default:
