                ...
                props.members.map((item, i, arr) => {
                    return (React.createElement("div", { key: i },
                        React.createElement(List_1.ListItem, { leftAvatar: (!!item.avatar) ?
                                React.createElement(Avatar_1.default, { src: item.avatar }) : React.createElement(Avatar_1.default, null, item.username.charAt(0)), primaryText: item.username, secondaryText: React.createElement("p", null,
...
exports.EditGroupMemberEnhanced = EditGroupMemberEnhancer_1.EditGroupMemberEnhancer(({ room_id, members, updateMembers, onToggleItem, onSubmit, onFinished }) => React.createElement(exports.EditGroupMember, { members: members, onToggleItem: onToggleItem, onSubmit: onSubmit }));
