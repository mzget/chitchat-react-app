...
exports.EditGroupMemberEnhanced = EditGroupMemberEnhancer_1.EditGroupMemberEnhancer(({ members, room_id, value, removeItem }) => React.createElement(EditGroupMember_1.EditGroupMember, { members: members, rightIconButton: (item) => (React.createElement(IconMenu_1.default, { iconButtonElement: iconButtonElement, onChange: (e, itemValue) => {
            if (itemValue == "1") {
                removeItem(item);
            }
        }, value: value },
