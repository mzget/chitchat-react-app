...
exports.ChatPageEnhanced = DialogBoxEnhancer_1.DialogBoxEnhancer(({ title, message, open, handleClose, onError, location, history, match }) => (React.createElement("div", null,
