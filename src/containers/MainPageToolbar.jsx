...
exports.WebToolbarEnhanced = ToolbarEnhancer_1.ToolbarEnhancer(function (_a) {
    ...
    return <SimpleToolbar_1.SimpleToolbar title={(teamReducer.team) ? teamReducer.team.name : ""} onPressTitle={onPressTitle} menus={menus} onSelectedMenuItem={onMenuSelect} groupItem={<ProfileBox_1.ProfileEnhanced />}/>;
});
exports.MobileToolbarEnhanced = ToolbarEnhancer_1.ToolbarEnhancer(function (_a) {
    ...
    return <SimpleToolbar_1.SimpleToolbar title={(teamReducer.team) ? teamReducer.team.name : ""} menus={menus} onSelectedMenuItem={onMenuSelect}/>;
});
