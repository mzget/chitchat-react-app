...
var Chat = (function (_super) {
    ...
    Chat.prototype.render = function () {
        ...
        return (<div style={{ height: "calc(100vh - 148px)" }}>
                <div style={{ overflowY: "scroll", height: "100%" }} id={"app_body"}>
                    {(this.state.earlyMessageReady) ?
            <reflexbox_1.Flex align="center" justify="center">
                                <p onClick={function () { return _this.onLoadEarlierMessages(); }}>Load Earlier Messages!</p>
                            </reflexbox_1.Flex>
            :
                null}
                    <ChatBox_1.ChatBox styles={{ overflowX: "hidden" }} value={this.state.messages} onSelected={function (message) { }}/>
                    {(this.state.openButtomMenu) ?
            <GridListSimple_1.default boxHeight={this.h_stickerBox} srcs={StickerPath_1.imagesPath} onSelected={this.onSubmitStickerChat}/>
            : null}

                </div>
                <div>
                    <TypingBox_1.TypingBox disabled={this.props.chatroomReducer.chatDisabled} onSubmit={this.onSubmitTextChat} onValueChange={this.onTypingTextChange} value={this.state.typingText} fileReaderChange={this.fileReaderChange} onSticker={this.onToggleSticker}/>
                    <UploadingDialog_1.default />
