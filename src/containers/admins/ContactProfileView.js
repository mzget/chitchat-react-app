...
export const ContactProfileView = (props) => {
    return (React.createElement(MuiThemeProvider, null,
        React.createElement(Flexbox, { flexDirection: "row", width: "100%", height: "calc(100vh -56px)", style: { backgroundColor: blueGrey50 } },
            React.createElement(Flexbox, { flexGrow: 1 }),
            React.createElement(Flexbox, { flexDirection: "column", justifyContent: "center", minWidth: "400", style: { overflowY: "auto", backgroundColor: darkWhite } },
                React.createElement(Flexbox, { justifyContent: "center", alignItems: "center", padding: "10px", style: { backgroundColor: darkBlack } }, props.member.avatar ? React.createElement(Avatar, { src: props.member.avatar, size: 100 })
