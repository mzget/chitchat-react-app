...
export const CreateOrgChartForm = (props) => (<MuiThemeProvider>
        <Flexbox style={{ backgroundColor: Colors.darkWhite }} width="100%" flexDirection="column" alignItems="center">
            ...
            <TextField hintText="Name" errorText="This field is required" value={props.orgChartName} onChange={props.onOrgChartNameChange} onKeyDown={(e) => {
    if (e.key === "Enter")
        props.onSubmit();
}}/>
            <span style={styles.span}/>
            <TextField hintText="Description" value={props.orgChart_description} onChange={props.onOrgChartDescriptionChange} onKeyDown={(e) => {
    if (e.key === "Enter")
        props.onSubmit();
}}/>
            <span style={styles.span}/>
