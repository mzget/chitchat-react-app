...
const renderList = (props) => (props.items.map((item, i) => (React.createElement("div", { key: i },
    React.createElement(ListItem, { leftIcon: null, rightIcon: null, primaryText: item.chart_name, secondaryText: React.createElement("p", { style: { color: darkBlack } }, item.chart_description), onClick: (event) => props.onSelected(item) }),
