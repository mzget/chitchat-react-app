...
var ChatLogsBox = (function (_super) {
    ...
    ChatLogsBox.prototype.render = function () {
        return (<div>
                <Subheader_1.default>Recent chats</Subheader_1.default>
                <ListChatLogs_1.ListChatLogs value={this.props.chatlogReducer.chatsLog} onSelected={this.enterRoom} onRemovedLog={this.removedLog}/>
            </div>);
    };
    return ChatLogsBox;
}(React.Component));
