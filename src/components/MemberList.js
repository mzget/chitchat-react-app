...
exports.addMemberView = (item, onAdded) => (React.createElement(IconButton_1.default, { tooltip: "Add Member", onClick: () => onAdded(item), style: { marginTop: 0 } },
...
const renderList = (props) => props.items.map((item, i) => React.createElement("div", { key: i },
    React.createElement(List_1.ListItem, { onClick: (!!props.onSelected) ? () => props.onSelected(item) : () => { }, leftAvatar: (!!item.avatar) ?
            React.createElement(Avatar_1.default, { size: 32, src: item.avatar }) : React.createElement(Avatar_1.default, { size: 32 }, item.username.charAt(0)), rightIcon: (props.onAdded) ? exports.addMemberView(item, props.onAdded) : null, rightToggle: (props.rightToggle) ?
