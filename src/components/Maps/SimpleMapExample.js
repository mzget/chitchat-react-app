 ...
 */
var SimpleGoogleMap = withScriptjs_1["default"](react_google_maps_1.withGoogleMap(function (props) { return (React.createElement(react_google_maps_1.GoogleMap, { defaultZoom: 8, defaultCenter: props.marker.position }, (props.marker) ? React.createElement(react_google_maps_1.Marker, __assign({}, props.marker)) : null)); }));
/*
...
exports.SimpleMapExample = SimpleMapExample;
